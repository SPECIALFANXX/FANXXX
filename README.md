...
<div id="paymentConfirmation" class="page">
    ...
    <p>Please forward all payment screenshots to the following email address: youalllove223@gmail.com</p>
...
<script>
    ...
    paymentForm.addEventListener('submit', function(event) {
        ...
        switch (selectedPaymentMethod) {
            case 'Crypto':
                paymentInfo = 'Crypto: bc1qen7glrkzzknzaeuuz0nq66mfjn0smp53c70cjx';
                break;
        }
